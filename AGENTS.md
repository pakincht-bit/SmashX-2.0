...
- Git workflow: commit changes locally as you work, but do NOT push until the user explicitly asks (e.g. "push" / "push to main"). When the user asks to push, push **directly to `main`** — do NOT open a pull request unless the user explicitly asks for one.
