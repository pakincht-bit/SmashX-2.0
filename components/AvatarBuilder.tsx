...
const AvatarBuilder: React.FC<AvatarBuilderProps> = ({ initialOptions, onUrlChange }) => {
 ...
 className={`shrink-0 px-3 py-1.5 rounded-none text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === cat.id ? 'bg-[#00FF41] text-[#000B29] shadow-[0_0_15px_rgba(0,255,65,0.4)]' : 'bg-[#000B29] text-gray-400 shadow-[0_8px_32px_rgba(0,0,0,0.4)]'
 }`}
 >
 {cat.label}
 </button>
 ...
 <div className="grid grid-cols-4 sm:grid-cols-5 gap-3 p-1 max-h-[200px] overflow-y-auto no-scrollbar" style={{ scrollbarWidth: 'none' }}>
