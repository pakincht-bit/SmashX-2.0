            ...
            <div className="bg-[#001645] border border-[#002266] rounded-2xl p-6 relative overflow-hidden shadow-xl">
                ...
                <div className="flex flex-col items-center justify-center mb-8 relative z-10">
                    <div className="relative group">
                        ...
                        <div 
                          className={`relative w-40 h-40 rounded-full border-4 border-[#002266] shadow-[0_0_40px_rgba(0,0,0,0.4)] overflow-hidden transition-all duration-500 preview-active ${getRankFrameClass(currentUser.rankFrame)}`}
