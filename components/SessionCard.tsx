...
const SessionCard: React.FC<SessionCardProps> = React.memo(({
 ...
 className="flex flex-col bg-[#1A1C23] rounded-none overflow-hidden cursor-pointer group (0,0,0,0.5)] transition-all duration-300 w-full"
 >
 {/* Top Banner Area */}
 ...
 <h3 className="text-2xl font-black text-white italic uppercase tracking-tight leading-none line-clamp-1 transition-colors shadow-black drop-shadow-sm">
