...
const InstallGuideModal: React.FC<InstallGuideModalProps> = ({ isOpen, onClose }) => {
 ...
 <div className="w-20 h-20 bg-[#00FF41] rounded-none flex items-center justify-center shadow-[0_0_40px_rgba(0,255,65,0.4)] mb-4">
 ...
 {isIOS ? (
 <>
 <div className="bg-[#001645] shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-4 rounded-none flex items-center gap-5">
 <div className="w-10 h-10 bg-white/10 rounded-none flex items-center justify-center text-[#00FF41] shrink-0 font-black">1</div>
 ...
 <div className="bg-[#001645] shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-4 rounded-none flex items-center gap-5">
 <div className="w-10 h-10 bg-white/10 rounded-none flex items-center justify-center text-[#00FF41] shrink-0 font-black">2</div>
 <div className="flex-1">
 ...
 <div className="bg-[#001645]/50 p-6 rounded-none border border-dashed border-white/5 border">
