...
const QueueDisplay: React.FC<QueueDisplayProps> = ({
 ...
 <div className="bg-[#001645] border border-[#00FF41]/30 rounded-none p-3 mb-4 flex items-center justify-between">
 ...
 {/* Pool Section - Top 6 */}
 <div className="bg-[#001645] shadow-[0_8px_32px_rgba(0,0,0,0.4)] rounded-none p-4 mb-4">
 ...
 <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-none p-2 mb-3 flex items-start gap-2">
