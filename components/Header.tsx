            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between relative">
                ...
                <div className="flex items-center">
                    ...
                    >
                        <div className="relative shrink-0">
                            <div className={`w-10 h-10 rounded-full p-0.5 shadow-lg transition-transform duration-300 group-hover:scale-105 ${getRankFrameClass(currentUser.rankFrame)}`}>
                                <img
                        ...
                        <div className="flex flex-col items-start justify-center">
                            ...
                            <span className="text-xl font-black text-white italic tracking-tighter truncate max-w-[160px] transition-colors group-hover:text-[#00FF41]">
                                {currentUser.name}
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                    <button
                        ...
                        className="p-2 sm:p-2.5 rounded-full transition-all shrink-0 bg-[#000B29]/50 hover:bg-[#000B29] text-gray-400 hover:text-[#00FF41] border border-transparent hover:border-[#00FF41]/30"
                        title="Activity Log"
                    >
                        <Calendar size={18} className="hover:animate-bounce" />
                    </button>
                    <button
                        onClick={(e) => {
                            e.stopPropagation();
                    ...
                    >
                        <History size={18} className="hover:animate-spin-slow" />
                    </button>
                    {showCreateButton && (
                        <button
                            onClick={() => {
                            ...
                            className="hidden sm:block bg-[#00FF41] hover:bg-white text-[#000B29] px-5 py-2.5 rounded-none -skew-x-12 text-sm font-black uppercase tracking-wider shadow-[0_0_20px_rgba(0,255,65,0.2)] transition-all hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] active:scale-95 items-center gap-2"
                        >
