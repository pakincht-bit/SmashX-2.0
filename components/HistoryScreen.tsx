                    ...
                    <div className="space-y-4">
                        ...
                        {hasMorePast && (
                            <button
                                ...
                                className="w-full mt-6 py-4 rounded-none border border-white/5 bg-transparent hover:bg-white/5 text-gray-400 hover:text-white transition-all font-bold uppercase tracking-widest text-xs disabled:opacity-50 flex items-center justify-center gap-2 disabled:cursor-not-allowed"
                            >
