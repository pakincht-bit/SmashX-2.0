...
const ArenaTiersModal: React.FC<ArenaTiersModalProps> = ({ isOpen, onClose, user }) => {
 ...
 <div className="max-w-md w-full bg-[#001645] shadow-[0_8px_32px_rgba(0,0,0,0.4)] rounded-none overflow-hidden shadow-2xl flex flex-col relative max-h-[90vh]">
 <div className="flex justify-between items-center p-4 border-b border-white/5 bg-[#000B29]">
