        ...
        <div className="w-full border border-[#002266] rounded-none overflow-hidden shadow-[0_0_50px_rgba(0,11,41,0.8)] p-0 flex items-center justify-center">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-1 z-10 w-full mt-2">
              ...
              <h2 className="text-3xl font-black italic text-white uppercase tracking-tighter leading-none shadow-black drop-shadow-lg">{titleInfo.title}</h2>
            </div>
            
            {/* Center Player Showcase */}
            <div className="relative flex flex-col items-center justify-center my-auto py-6 z-10">
              <div className={`rounded-full shadow-[0_0_40px_rgba(0,0,0,0.5)] ${getRankFrameClass(user.rankFrame).replace('ring-4', 'ring-2')}`}>
              ...
              <div className="mt-5 bg-[#000B29]/90 border border-[#002266] backdrop-blur-md px-6 py-2 rounded-full shadow-lg">
                  <span className="text-white font-black text-lg tracking-wide uppercase">{user.name}</span>
              </div>
            </div>
